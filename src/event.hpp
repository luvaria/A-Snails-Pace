...
{
public:
	enum EventType { COLLISION, LOAD_LEVEL, LOAD_SAVE, LOAD_BG, CLOSE_BG, MENU_START, MENU_OPEN, MENU_CLOSE, MENU_CLOSE_ALL, PAUSE, UNPAUSE, TILE_OCCUPIED, TILE_UNOCCUPIED, LEVEL_LOADED, START_DIALOGUE, NEXT_DIALOGUE, RESUME_DIALOGUE, END_DIALOGUE, LEVEL_COMPLETE, NEXT_LEVEL, GAME_OVER, SPLASH };
